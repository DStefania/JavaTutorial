...
public class Telefon {
    ...
    prezentareTelefon("16 Pro Max", "iPhone","White",7.420,"stare buna");
    discountTelefon();
    System.out.println();
    prezentareTelefon("14 Pro Max","Iphone","Black",6.210,"in reparatii");
    System.out.println();
    prezentareTelefon("S24","Samsung","Purple",6.100,"stare critica");
    }


    //metodele pot sau nu sa contina parametrii
    //scopul parametrilor este sa defineasca intr-un mod generic o anumita actiune
    //o metoda poate avea 1 sau mai multi parametrii delimitati prin virgula
    //un parametru trebuie sa contina tipul de data si numele acestuia
    //parametrii se definesc intre paranteze rotunde
    ...
    public void prezentareTelefon(String param1, String param2, String param3,double param4,String param5){
        ...
        System.out.println("Starea telefonului este: "+caracteristici);
    }
